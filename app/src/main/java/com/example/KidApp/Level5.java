...
public class Level5 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        collectedAnimals = animal_collector(8);

        ImageView img0 = (ImageView) findViewById(R.id.L5I0);
        ImageView img1 = (ImageView) findViewById(R.id.L5I1);
        ImageView img2 = (ImageView) findViewById(R.id.L5I2);
        ImageView img3 = (ImageView) findViewById(R.id.L5I3);
        ImageView img4 = (ImageView) findViewById(R.id.L5I4);
        ImageView img5 = (ImageView) findViewById(R.id.L5I5);
        ImageView img6 = (ImageView) findViewById(R.id.L5I6);
        ImageView img7 = (ImageView) findViewById(R.id.L5I7);
        ...
        img6.setImageResource(collectedAnimals.get(6).image);
        img6.setTag(collectedAnimals.get(6).name);
        img7.setImageResource(collectedAnimals.get(7).image);
        img7.setTag(collectedAnimals.get(7).name);

        selectedAnimal = animal_selector(collectedAnimals);
        TextView text = (TextView) findViewById(R.id.L5Name);
        text.setText(selectedAnimal.name);

        TextView pointTxt = (TextView) findViewById(R.id.L5Point);
        pointTxt.setText("Point " + point);

        TextView best = (TextView) findViewById(R.id.L5best);
    ...
    public void clicked(View v) throws InterruptedException {
        if(selectedAnimal.name.equals(v.getTag().toString()))
        {
            ...
            if(point==15)
            {
                tts.speak("You win .... ", TextToSpeech.QUEUE_FLUSH,null);
    ...
    CountDownTimer timer = new CountDownTimer(14000, 1000) {
        ...
        public void onTick(long millisUntilFinished) {
            TextView timerTxt = (TextView) findViewById(R.id.L5Timer);
